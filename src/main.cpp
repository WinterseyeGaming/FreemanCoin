...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // FreedomCoin: 1 days
static const int64 nTargetSpacing = 120; // FreedomCoin: 2 min
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal freedomcoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Stock markets across Europe are down in the wake of Greek NO";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xe94cd5de59cbd07bd15e9dfe58a4bbef5262b705eb2a8a80199289892879df9a"));
